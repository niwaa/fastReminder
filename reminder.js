...
class Reminder {
  ...
  addReminder (comment, dateObject) {
    return new Promise((resolve, reject) => {
      ...
      let _this = this
      this.addReminderToStore(comment, dateObject)
        .then(function () {
          _this.addPushNotification(comment, dateJs)
          resolve()
        })
  ...
  addPushNotification (comment, dateJs) {
  ...
  async addReminderToStore (comment, dateObject) {
